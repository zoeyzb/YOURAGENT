  ...
  return (
    <main><div className="shell section">
      <div className="dash-top">
        ...
        <div className="nav-actions"><Link className="btn" href="/calls">Calls · {callCount ?? 0}</Link><span className="eyebrow">SIGNED IN</span></div>
      </div>
